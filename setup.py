...
if os.environ.get("USE_SYSTEM_EIGEN", "0") == "0":
    ...
    # Use include_dirs instead of -isystem for cross-platform compatibility
    additional_include_dirs = [additional_include_path]
else:
...
setup(
    ...
    ext_modules=[
        CUDAExtension(
            ...
            include_dirs=additional_include_dirs,  # type: ignore
